...
urlpatterns = [
    ...
    path('admin-panel/animals/', views.admin_page, name='ui_admin_animals'),
    ...
    # Admin API
    path("api/admin-panel/animals/<int:pk>/approve/", views.approve_animal_api, name="approve_animal"),
    path("api/admin-panel/animals/<int:pk>/reject/", views.reject_animal_api, name="reject_animal"),
